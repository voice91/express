...
module.exports = {
  ...
  up: function up(db) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var LenderPlacement, User, placements, count;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 8:
            placements = _context3.sent;
            count = 0;
            _context3.next = 12;
            return Promise.all(placements.map( /*#__PURE__*/function () {
              var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(placement) {
                return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                  while (1) switch (_context2.prev = _context2.next) {
                    case 0:
                      _context2.next = 2;
                      return Promise.all(placement.messages.map( /*#__PURE__*/function () {
                          ...
                          return _regeneratorRuntime().wrap(function _callee$(_context) {
                            while (1) switch (_context.prev = _context.next) {
                              ...
                              case 2:
                                ...
                                _context.next = 6;
                                return LenderPlacement.updateOne({
                                  _id: placement._id,
