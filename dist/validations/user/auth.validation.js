...
var register = exports.register = {
  body: _joi["default"].object().keys({
    ...
    state: (_Joi$string2 = _joi["default"].string()).valid.apply(_Joi$string2, _toConsumableArray(Object.values(_enum["default"].EnumStatesOfDeal))).required(),
    zipcode: _joi["default"].number().integer().min(100).max(999999).required(),
...
var createDeviceToken = exports.createDeviceToken = {
  body: _joi["default"].object().keys({
    deviceToken: _joi["default"].string(),
    platform: (_Joi$string3 = _joi["default"].string()).valid.apply(_Joi$string3, _toConsumableArray(Object.values(_enum["default"].EnumPlatformOfDeviceToken)))
  })
};
