...
export const createEmailTemplate = {
  body: Joi.object().keys({
    ...
    emailAttachments: Joi.string().regex(new RegExp(`https://${config.aws.bucket}.s3.amazonaws.com\\b([-a-zA-Z0-9()@:%_+.~#?&amp;/=]*.(pdf|doc|docx|ppt|pptx|xls|xlsx)$)`)).allow(''),
...
export const updateEmailTemplate = {
  body: Joi.object().keys({
    ...
    emailAttachments: Joi.string().regex(new RegExp(`https://${config.aws.bucket}.s3.amazonaws.com\\b([-a-zA-Z0-9()@:%_+.~#?&amp;/=]*.(pdf|doc|docx|ppt|pptx|xls|xlsx)$)`))
  }),
