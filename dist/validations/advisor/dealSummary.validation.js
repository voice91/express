...
export const createDealSummary = {
  body: Joi.object().keys({
     ...
     */
    dynamicField: Joi.array().items(Joi.object().keys({
      name: Joi.string().required(),
      type: Joi.string().valid(...Object.values(enumFields.EnumOfDynamicFieldType)).required(),
