...
var updateUser = exports.updateUser = {
  body: _joi["default"].object().keys({
    name: _joi["default"].string(),
    appPassword: _joi["default"].string(),
    email: _joi["default"].string().email(),
    sendEmailFrom: _joi["default"].string().email(),
    role: (_Joi$string4 = _joi["default"].string()).valid.apply(_Joi$string4, _toConsumableArray(Object.values(_enum["default"].EnumRoleOfUser))),
    codes: _joi["default"].array().items(codesEmbed),
    password: _joi["default"].string(),
    googleProvider: googleProviderEmbed,
    firstName: _joi["default"].string().required(),
    ...
    state: (_Joi$string5 = _joi["default"].string()).valid.apply(_Joi$string5, _toConsumableArray(Object.values(_enum["default"].EnumStatesOfDeal))).allow(null),
    zipcode: _joi["default"].number().integer().min(100).max(999999).allow(null),
    lastSignIn: _joi["default"].date(),
    profilePhoto: _joi["default"].string(),
    emailPresentingPostmark: _joi["default"].bool()["default"](false),
    signature: _joi["default"].string().allow(null)
  })
};
