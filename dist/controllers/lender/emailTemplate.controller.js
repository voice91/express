            ...
            var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(key) {
              ...
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    fieldValidation = _fileFieldValidation["default"]["".concat(key, "OfEmailTemplate")];
                    basePath = "users/".concat(user._id, "/emailTemplate/").concat(body._id, "/").concat(key, "/").concat(_mongoose["default"].Types.ObjectId(), "/");
...
var get = exports.get = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var emailTemplateId, filter, options, emailTemplate;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          options = {};
          _context5.next = 5;
          return _services.emailTemplateService.getOne(filter, options);
        case 5:
...
var list = exports.list = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var filter, options, emailTemplate;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          options = {};
          _context6.next = 4;
          return _services.emailTemplateService.getEmailTemplateList(filter, options);
        case 4:
...
var paginate = exports.paginate = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var query, sortingObj, sortObj, filter, options, emailTemplate;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          _context7.next = 8;
          return _services.emailTemplateService.getEmailTemplateListWithPagination(filter, options);
        case 8:
          emailTemplate = _context7.sent;
          emailTemplate.results = emailTemplate.results.map(function (emailTemplateObject) {
...
var create = exports.create = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var body, user, moveFileObj, options, emailTemplateResult, uploadedFileUrls;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          ...
          user = req.user;
          moveFileObj = _objectSpread({}, body.emailAttachments && {
            emailAttachments: body.emailAttachments
          });
        ...
        case 8:
          options = {};
          _context8.next = 11;
          return _services.emailTemplateService.createEmailTemplate(body, options);
        case 11:
          emailTemplateResult = _context8.sent;
...
var update = exports.update = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(req, res) {
    var body, emailTemplateId, user, moveFileObj, filter, options, emailTemplateResult, uploadedFileUrls;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 8:
          ...
          _context9.next = 12;
          return _services.emailTemplateService.updateEmailTemplate(filter, body, options);
        case 12:
          emailTemplateResult = _context9.sent;
          if (!emailTemplateResult) {
            _context9.next = 18;
            break;
          }
...
var remove = exports.remove = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var emailTemplateId, filter, emailTemplate;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          ...
          _context10.next = 4;
          return _services.emailTemplateService.removeEmailTemplate(filter);
        case 4:
          emailTemplate = _context10.sent;
