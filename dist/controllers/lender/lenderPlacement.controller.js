...
exports.update = exports.sendMessage = exports.removeDocument = exports.remove = exports.paginate = exports.list = exports.getMessages = exports.get = exports.create = void 0;
              ...
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                      ...
                      var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(ele) {
                        ...
                        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                          while (1) switch (_context2.prev = _context2.next) {
                            case 0:
                              filePath = "".concat(_mongoose["default"].Types.ObjectId(), "_").concat(ele.split('/').pop());
                  ...
                  case 15:
                    ...
                    break;
                  case 21:
                    filePath = "".concat(_mongoose["default"].Types.ObjectId(), "_").concat(moveFileObj[key].split('/').pop());
...
var list = exports.list = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var query, user, queryParams, sortingObj, sortObj, lenderContact, filter, options, lenderPlacements, lenderPlacement;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 13:
          ...
          lenderPlacement = lenderPlacements.filter(function (placement) {
            return placement.lenderAllContacts.map(function (contact) {
...
var paginate = exports.paginate = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var query, sortingObj, sortObj, lenderContact, deal, filter, options, lenderPlacement;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          query = req.query;
          sortingObj = (0, _pick.pick)(query, ['sort', 'order']);
          sortObj = _defineProperty({}, sortingObj.sort, sortingObj.order); // as we need placement stage and timeline for particular lender only so we are adding the below condition for this
          _context7.next = 5;
          return _services.lenderContactService.getOne({
        ...
        case 5:
          ...
          _context7.next = 8;
          return _services.dealService.getDealList({
            'involvedUsers.lenders': req.user._id
          });
        case 8:
          deal = _context7.sent;
          filter = {
            lenderContact: lenderContact._id,
            deal: deal.map(function (item) {
              return item._id;
            })
...
var create = exports.create = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var body, user, moveFileObj, options, lenderPlacementResult, uploadedFileUrls;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 8:
          options = {};
          _context8.next = 11;
          return _services.lenderPlacementService.createLenderPlacement(body, options);
        case 11:
          lenderPlacementResult = _context8.sent;
...
var update = exports.update = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(req, res) {
    var body, lenderPlacementId, user, termsheet, moveFileObj, filter, fileName, futureFunding, options, beforeLenderPlacementResult, oldStage, lenderPlacementResult, dealId, stage, createActivityLogBody, uploadedFileUrls, _createActivityLogBody, _stage, _createActivityLogBody2, _stage2;
      ...
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 9:
          ...
          if (body.termSheet) {
            ...
            body.termSheet = {
              url: (0, _common.encodeUrl)(body.termSheet),
              fileName: fileName
            };
          }
          if (body.terms) {
          ...
          _context9.next = 15;
          return _services.lenderPlacementService.getLenderPlacementById(lenderPlacementId);
        case 15:
          beforeLenderPlacementResult = _context9.sent;
          oldStage = beforeLenderPlacementResult.stage; // check & throw error if term is not added
        ...
        case 26:
          lenderPlacementResult = _context9.sent;
          dealId = lenderPlacementResult.deal;
          if (!(lenderPlacementResult.stage === _enum["default"].EnumStageOfLenderPlacement.CLOSING)) {
            _context9.next = 44;
            break;
          }
          stage = _enum["default"].EnumStageOfDeal.CLOSING;
          _context9.t0 = _services.dealService;
          _context9.t1 = {
            _id: dealId
          };
          _context9.t2 = stage;
          _context9.t3 = (0, _common.manageLenderPlacementStageTimeline)(oldStage, stage, beforeLenderPlacementResult.timeLine);
          _context9.next = 36;
          return (0, _detailsInDeal.detailsInDeal)(stage, dealId);
        case 36:
          _context9.t4 = _context9.sent;
          _context9.t5 = _enum["default"].EnumNextStepOfLenderPlacement[stage];
          _context9.t6 = {
            stage: _context9.t2,
            timeLine: _context9.t3,
            details: _context9.t4,
            nextStep: _context9.t5
          };
          _context9.next = 41;
          return _context9.t0.updateDeal.call(_context9.t0, _context9.t1, _context9.t6);
        case 41:
          // commenting user in case we need it again in future
          createActivityLogBody = {
            createdBy: req.user._id,
            updatedBy: req.user._id,
            update: "".concat(lenderPlacementResult.deal.dealName, " moved into closing with ").concat(lenderPlacementResult.lendingInstitution.lenderNameVisible),
            deal: dealId,
        ...
        case 53:
          _stage = _enum.EnumStageOfLenderPlacement.TERMS_SHEET_RECEIVED;
          _context9.next = 56;
          return _services.lenderPlacementService.updateLenderPlacement({
            _id: lenderPlacementId
          }, {
            stage: _stage,
            stageEnumWiseNumber: (0, _enumStageOfLenderPlacement.stageOfLenderPlacementWithNumber)(_stage),
            timeLine: (0, _common.manageLenderPlacementStageTimeline)(oldStage, _stage, beforeLenderPlacementResult.timeLine),
            nextStep: _enum["default"].EnumNextStepOfLenderPlacement[_stage]
          });
        case 56:
        ...
        case 60:
          _stage2 = _enum.EnumStageOfLenderPlacement.TERMS_RECEIVED;
          _context9.next = 63;
          return _services.lenderPlacementService.updateLenderPlacement({
            _id: lenderPlacementId
          }, {
...
var sendMessage = exports.sendMessage = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(req, res) {
    var lenderPlacementId, lender, body;
