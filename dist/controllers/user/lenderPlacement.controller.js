...
exports.updateMany = exports.update = exports.removeByDealAndLendingInstitution = exports.remove = exports.paginate = exports.list = exports.getDocumentsOfMessages = exports.get = exports.create = void 0;
...
var list = exports.list = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var query, queryParams, sortingObj, sortObj, filter, options, lenderPlacement;
      ...
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          if (body.stage) {
            ...
            body.nextStep = _enum["default"].EnumNextStepOfLenderPlacement[body.stage];
          }
        ...
        case 9:
          ...
          _context9.next = 12;
          return (0, _common.asyncForEach)(body.lendingDetails, /*#__PURE__*/function () {
            var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(lendingInstitute) {
...
var update = exports.update = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var body, lenderPlacementId, user, moveFileObj, filter, options, lenderPlacementResult, uploadedFileUrls;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        ...
        case 12:
          lenderPlacementResult = _context10.sent;
          if (!lenderPlacementResult) {
            _context10.next = 18;
            break;
          }
    ...
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        case 0:
          ...
          return _services.lenderPlacementService.removeLenderPlacement(filter);
        case 4:
          lenderPlacement = _context13.sent;
 ...
 */
var getDocumentsOfMessages = exports.getDocumentsOfMessages = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref16 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(req, res) {
    var lenderPlacementId, filter, options, lenderPlacement, documents;
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        case 0:
          ...
          return _services.lenderPlacementService.getOne(filter, options);
        case 5:
          lenderPlacement = _context14.sent;
          documents = _lodash["default"].flatten(lenderPlacement.messages.map(function (message) {
