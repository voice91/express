...
exports.update = exports.importFileForDealSummary = exports.get = exports.create = void 0;
...
var importFileForDealSummary = exports.importFileForDealSummary = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var _req$query, url, deal, dealSummary;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _req$query = req.query, url = _req$query.url, deal = _req$query.deal;
          _context5.next = 3;
...
var update = exports.update = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var body, _body, otherPhotos, dealSummaryId, user, moveFileObj, filter, fileName, options, dealSummary, uploadedFileUrls, uploadedFileUrl;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          body = req.body;
          _body = body, otherPhotos = _body.otherPhotos;
          body.updatedBy = req.user;
          dealSummaryId = req.params.dealSummaryId;
          user = req.user;
          moveFileObj = _objectSpread({}, body.otherPhotos && {
