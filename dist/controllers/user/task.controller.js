...
exports.update = exports.removeTaskDocument = exports.remove = exports.paginate = exports.listByDeal = exports.list = exports.get = void 0;
...
var removeTaskDocument = exports.removeTaskDocument = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(req, res) {
    var taskDocumentId, user, filter, updateDocument, options, task, taskAnswer, updatedTask;
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          ...
          _context11.next = 7;
          return _services.taskService.getOne(filter);
        case 7:
        ...
        case 10:
          ...
          taskAnswer = task.taskAnswer.find(function (answer) {
            return answer.taskDocuments.some(function (doc) {
              return doc._id.toString() === taskDocumentId;
            });
          ...
          throw new _ApiError["default"](_httpStatus["default"].FORBIDDEN, 'You are not authorized to delete this document');
        case 13:
          _context11.next = 15;
          return _services.taskService.updateTask(filter, updateDocument, options);
        case 15:
          updatedTask = _context11.sent;
