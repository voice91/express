...
export const update = catchAsync(async (req, res) => {
  ...
  const moveFileObj = {
    ...(body.taskDocuments && {
      taskDocuments: body.taskDocuments.map(item => item.url)
    })
  };
  body._id = taskId;
  await moveFiles({
...
export const removeTaskDocument = catchAsync(async (req, res) => {
  ...
  const taskAnswer = task.taskAnswer.find(answer => answer.taskDocuments.some(doc => doc._id.toString() === taskDocumentId));
