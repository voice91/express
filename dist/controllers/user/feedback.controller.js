...
var create = exports.create = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var body, options, getUser, emailPresentingPostmark, attachments, feedback;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          _context2.next = 10;
          return Promise.all(body.images.map( /*#__PURE__*/function () {
        ...
        case 10:
          ...
          _context2.next = 13;
          return _services.feedbackService.createFeedback(body, options);
        case 13:
          feedback = _context2.sent;
          _context2.next = 16;
          return _services.emailService.sendFeedbackEmail(_objectSpread(_objectSpread({}, emailPresentingPostmark && {
            from: req.user.email
          }), {}, {
            to: _config["default"].adminEmailId,
