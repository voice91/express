...
exports.update = exports.remove = exports.paginate = exports.list = exports.getLendingInstitutionFeedBack = exports.get = exports.create = void 0;
            ...
            var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(key) {
              ...
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    fieldValidation = _fileFieldValidation["default"]["".concat(key, "OfLendingInstitution")];
                    basePath = "users/".concat(user._id, "/lenderInstitution/").concat(body._id, "/").concat(key, "/").concat(_mongoose["default"].Types.ObjectId(), "/");
...
var getLendingInstitutionFilterQuery = function getLendingInstitutionFilterQuery(query) {
...
var get = exports.get = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var lendingInstitutionId, filter, options, lendingInstitution;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          lendingInstitutionId = req.params.lendingInstitutionId;
          filter = {
            _id: lendingInstitutionId
          };
          options = {};
          _context5.next = 5;
          return _services.lendingInstitutionService.getOne(filter, options);
        case 5:
          lendingInstitution = _context5.sent;
          return _context5.abrupt("return", res.status(_httpStatus["default"].OK).send({
            results: lendingInstitution
          }));
        case 7:
        case "end":
...
var list = exports.list = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var query, dealId, queryParams, sortingObj, sortObj, filter, fields, lenderProgram, filterLenderProgram, filterFields, isFilterField, options, lendingInstitution, lenderPlacements, lendingInstitutionsWithProgramData;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          query = req.query;
          dealId = query.dealId;
          queryParams = getLendingInstitutionFilterQuery(query);
          ...
          fields = (0, _pick.pick)(query, ['loanType', 'propertyType', 'statesArray', 'lenderInstitute', 'loanSize', 'lenderType', 'lenderNameVisible']);
          lenderProgram = [];
          filterLenderProgram = {}; // condition to check whether the field in the query are these four ('loanType', 'propertyType', 'statesArray', 'loanSize') only.
          filterFields = ['loanType', 'propertyType', 'statesArray', 'loanSize'];
          Object.keys(fields).forEach(function (field) {
            if (filterFields.includes(field)) {
              if (field === 'loanSize') {
                filterLenderProgram.$and = [{
                  minLoanSize: {
                    $lte: query.loanSize
                  }
                }, {
          ...
          isFilterField = Object.keys(fields).some(function (property) {
            return filterFields.includes(property);
          });
          if (!isFilterField) {
            _context6.next = 16;
            break;
          ...
          _context6.next = 15;
          return _models.LenderProgram.find(filterLenderProgram);
        case 15:
        ...
        case 16:
          Object.keys(fields).forEach(function (field) {
            if (filterFields.includes(field)) {
              filter._id = {
                $in: lenderProgram.map(function (item) {
                  return item.lenderInstitute;
                })
              };
          ...
          _context6.next = 21;
          return _services.lendingInstitutionService.getLendingInstitutionList(filter, options);
        case 21:
        ...
        case 24:
          lenderPlacements = _context6.sent;
          lendingInstitutionsWithProgramData = lendingInstitution.map(function (lendingInstitutionObject) {
            var programs = lendingInstitutionObject.lenderProgram;
            return _objectSpread(_objectSpread({
              // isAlreadyAdded indicates that lender is already added in deal or not
              isAlreadyAdded: lenderPlacements.some(function (lender) {
                return lender.lendingInstitution.toString() === lendingInstitutionObject._id.toString();
              }),
              createdAt: lendingInstitutionObject.createdAt
            }, lendingInstitutionObject.toJSON()), {}, {
              lenderProgram: {
                minLoanSize: Math.min.apply(Math, _toConsumableArray(programs.map(function (program) {
                  return program.minLoanSize;
                }).filter(Boolean))),
                maxLoanSize: Math.max.apply(Math, _toConsumableArray(programs.map(function (program) {
                  return program.maxLoanSize;
                }).filter(Boolean))),
                propertyTypes: _toConsumableArray(new Set(programs.flatMap(function (program) {
                  return program.propertyType;
                }))),
                loanTypes: _toConsumableArray(new Set(programs.flatMap(function (program) {
                  return program.loanType;
                }))),
                statesArray: _toConsumableArray(new Set(programs.flatMap(function (program) {
                  return program.statesArray;
                }))),
                lenderProgramTypes: _toConsumableArray(new Set(programs.flatMap(function (program) {
                  return program.lenderProgramType;
                })))
              }
            });
          });
          return _context6.abrupt("return", res.status(_httpStatus["default"].OK).send({
            results: lendingInstitutionsWithProgramData
          }));
        case 27:
        case "end":
...
var paginate = exports.paginate = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var query, dealId, queryParams, sortingObj, sortObj, filter, fields, lenderProgram, filterLenderProgram, filterFields, isFilterField, options, lendingInstitution, lenderPlacements;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 16:
          ...
          _context7.next = 21;
          return _services.lendingInstitutionService.getLendingInstitutionListWithPagination(filter, options);
        case 21:
        ...
        case 24:
          lenderPlacements = _context7.sent;
          lendingInstitution.results = lendingInstitution.results.map(function (lendingInstitutionObject) {
            var programs = lendingInstitutionObject.lenderProgram;
            return _objectSpread(_objectSpread({
              // isAlreadyAdded indicates that lender is already added in deal or not
              isAlreadyAdded: lenderPlacements.some(function (lender) {
...
var create = exports.create = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var body, options, lendingInstitution;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          ...
          options = {};
          _context8.next = 6;
          return _services.lendingInstitutionService.createLendingInstitution(body, options);
        case 6:
...
var update = exports.update = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(req, res) {
    var body, user, lendingInstitutionId, logo, moveFileObj, filter, fileName, options, lendingInstitution, uploadedFileUrls;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          lendingInstitutionId = req.params.lendingInstitutionId;
          logo = body.logo;
          moveFileObj = _objectSpread({}, body.logo && {
            logo: body.logo.url
          });
        ...
        case 10:
          ...
          if (body.logo) {
            ...
            body.logo = {
              url: (0, _common.encodeUrl)(body.logo),
              fileName: fileName
            };
          }
          options = {
          ...
          _context9.next = 15;
          return _services.lendingInstitutionService.updateLendingInstitutionDetails(filter, body, options);
        case 15:
...
var remove = exports.remove = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var lendingInstitutionId, filter, lendingInstitution;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          ...
          _context10.next = 4;
          return _services.lendingInstitutionService.removeLendingInstitution(filter);
        case 4:
...
var getLendingInstitutionFeedBack = exports.getLendingInstitutionFeedBack = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(req, res) {
    var lendingInstitutionId, filter, options, feedBacks;
        ...
        case 0:
          ...
          filter = {
            ...
            $or: [{
              ...
              stage: _enum.EnumStageOfLenderPlacement.PASS
            }]
          };
          options = {
            populate: {
