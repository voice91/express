...
import { addIndexForCustomBlocks, addSymbolInData, asyncForEach, encodeUrl, removeFalsyValueFromDealSummery, validateLoanAmount, removeNullFields } from "../../utils/common";
...
export const update = catchAsync(async (req, res) => {
  ...
  const moveFileObj = {
    ...(body.otherPhotos && {
      otherPhotos: body.otherPhotos.map(item => item.url)
    }),
    ...(body.mainPhoto && {
