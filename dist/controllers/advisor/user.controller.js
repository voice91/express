 ...
 */
var getUserFilterQuery = function getUserFilterQuery(query) {
...
var get = exports.get = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var userId, filter, options, user;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          options = {};
          _context.next = 5;
          return _services.userService.getOne(filter, options);
        case 5:
          user = _context.sent;
...
var list = exports.list = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var query, queryParams, filter, options, user;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          query = req.query;
          queryParams = getUserFilterQuery(query);
          filter = _objectSpread({}, queryParams);
          options = _objectSpread({}, (0, _pick.pick)(query, ['sort', 'limit', 'page']));
          _context2.next = 6;
          return _services.userService.getUserList(filter, options);
        case 6:
          user = _context2.sent;
...
var paginate = exports.paginate = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var query, queryParams, sortingObj, sortObj, filter, options, user;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 9;
          return _services.userService.getUserListWithPagination(filter, options);
        case 9:
          user = _context3.sent;
          user.results = user.results.map(function (userObject) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          options = {};
          _context4.next = 4;
          return _services.userService.createUser(body, options);
        case 4:
          user = _context4.sent;
...
var update = exports.update = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var body, userId, filter, options, user;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 7;
          return _services.userService.updateUser(filter, body, options);
        case 7:
          user = _context5.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _context6.next = 4;
          return _services.userService.removeUser(filter);
        case 4:
          user = _context6.sent;
