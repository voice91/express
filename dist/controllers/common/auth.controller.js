...
exports.verifyEmail = exports.userInfo = exports.sendVerifyEmail = exports.resetPassword = exports.register = exports.login = exports.forgotPassword = exports.enforcePassword = void 0;
...
var register = exports.register = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var body, loggedInUser, isRedirectedFromSendDeal, emailAccessToRegisterBorrower, LenderInvitation, isLenderContact, lenderInfo, user, tokens, _user;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          body = req.body;
          loggedInUser = req.user;
          isRedirectedFromSendDeal = body.isRedirectedFromSendDeal;
          emailAccessToRegisterBorrower = loggedInUser.email === _config["default"].emailAccessToRegisterBorrower;
          if (!isRedirectedFromSendDeal) {
            _context.next = 32;
            break;
          }
          _context.next = 7;
          return _services.invitationService.getOne({
            inviteeEmail: body.email,
            role: _enum["default"].EnumRoleOfUser.LENDER,
            status: _enum["default"].EnumTypeOfStatus.PENDING
          });
        case 7:
          LenderInvitation = _context.sent;
          if (!LenderInvitation) {
            _context.next = 29;
            break;
          }
        ...
        case 20:
          ...
          _context.next = 23;
          return _services.invitationService.updateInvitation({
            _id: LenderInvitation._id
          }, {
            status: _enum["default"].EnumTypeOfStatus.ACCEPTED
          });
        case 23:
          ...
          break;
        case 26:
          throw new _ApiError["default"](_httpStatus["default"].BAD_REQUEST, 'Invalid lender email');
        case 27:
          _context.next = 30;
          break;
        case 29:
        ...
        case 32:
          ...
          throw new _ApiError["default"](_httpStatus["default"].UNAUTHORIZED, "You don't have access to register borrower");
        case 34:
          Object.assign(body, {
            emailVerified: true,
 ...
 * * @type {(function(*, *, *): void)|*}
 */
var enforcePassword = exports.enforcePassword = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return _services.userService.enforcePassword(req.user._id, req.body);
        case 2:
          user = _context6.sent;
          res.status(_httpStatus["default"].OK).send({
            results: {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 2:
          ...
          throw new _ApiError["default"](_httpStatus["default"].BAD_REQUEST, "User doesn't exist");
        case 5:
          _context7.next = 7;
          return _services.tokenService.generateResetPasswordToken(req.body.email);
        case 7:
          resetPasswordToken = _context7.sent;
          _context7.next = 10;
          return _services.emailService.sendResetPasswordEmail(resetPasswordToken, user);
        case 10:
          res.status(_httpStatus["default"].OK).send({
            success: true,
            message: 'Link to forgot password has been sent'
          });
        case 11:
        case "end":
 ...
 */
var resetPassword = exports.resetPassword = (0, _catchAsync.catchAsync)( /*#__PURE__*/function () {
