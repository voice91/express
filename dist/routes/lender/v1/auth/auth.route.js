...
import { authValidation } from "../../../../validations/lender";
import { authController } from "../../../../controllers/lender";
// import verifyCaptcha from 'middlewares/captcha';
const router = express.Router();
/**
 * Register API
 */
router.post('/register', validate(authValidation.register), /* verifyCaptcha('captcha'), // we have disable the captcha so that nothing will break in the code. */
 ...
 */
router.post('/reset-password-based-on-token', validate(authValidation.resetPasswordToken), authController.resetPasswordToken);
/**
 ...
 */
router.post('/register-device-token', auth(), validate(authValidation.createDeviceToken), authController.registerDeviceToken);
/**
 ...
 */
router.post('/google', validate(authValidation.googleLogin), passport.authenticate('google-token', {
  session: false,
  json: true
