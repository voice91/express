 ...
 */.get(auth('user'), validate(dealDocumentValidation.getDealDocument), checkAccessOfDeal, dealDocumentController.getDealDocumentByDeal);
router.route('/v2/add')
/**
 * createDealDocument updated flow
 * */.post(auth('user'), validate(dealDocumentValidation.createDealDocumentV2), checkAccessOfDeal, dealDocumentController.createV2);
router.route('/v2/deal/:dealId')
/**
 * getDealDocuments list by deal
 * */.get(auth('user'), validate(dealDocumentValidation.getDealDocument), checkAccessOfDeal, dealDocumentController.getDealDocumentByDealV2);
...
/**
 * updateDealDocument
 * */.put(auth('user'), validate(dealDocumentValidation.updateDealDocument), checkAccessOfDeal, dealDocumentController.update).delete(auth('user'), validate(dealDocumentValidation.removeDealDocumentById), dealDocumentController.remove);
router.route('/documents/:documentId').delete(auth('user'), validate(dealDocumentValidation.deleteDocument), dealDocumentController.removeDocuments);
