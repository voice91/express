 ...
 */.get(auth('user'), validate(lenderPlacementValidation.getDocumentsOfMessages), lenderPlacementController.getDocumentsOfMessages);
router.route('/remove')
/**
 ...
 */.delete(auth('user'), validate(lenderPlacementValidation.removeLenderPlacement), lenderPlacementController.removeByDealAndLendingInstitution);
router.route('/update')
/**
