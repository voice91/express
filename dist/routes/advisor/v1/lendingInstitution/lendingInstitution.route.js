 ...
 * */.post(auth('advisor'), validate(lendingInstitutionValidation.createLendingInstitution), lendingInstitutionController.create)
/**
 ...
 * */.get(auth('advisor'), validate(lendingInstitutionValidation.paginatedLendingInstitution), lendingInstitutionController.paginate);
 ...
 * */.delete(auth('advisor'), validate(lendingInstitutionValidation.deleteLendingInstitutionById), lendingInstitutionController.remove);
router.route('/:lendingInstitutionId/feed-back')
/**
 * getLendingInstitutionById
 * */.get(auth('advisor'), validate(lendingInstitutionValidation.getLendingInstitutionFeedBack), lendingInstitutionController.getLendingInstitutionFeedBack);
