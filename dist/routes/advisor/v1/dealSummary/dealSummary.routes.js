 ...
 * */.get(auth('advisor'), validate(dealSummaryValidation.importFileForDealSummary), dealSummaryController.importFileForDealSummary);
router.route('/create')
/**
 * createDealSummary
 ...
 */.post(auth('advisor'), validate(dealSummaryValidation.exportFileForDealSummary), dealSummaryController.exportFileForDealSummary);
