...
LenderContactSchema.statics.isEmailTaken = async function (email, excludeLenderContactId) {
  const lenderContact = await this.findOne({
    email,
    _id: {
...
const LenderContactModel = mongoose.models.LenderContact || mongoose.model('LenderContact', LenderContactSchema, 'LenderContact');
