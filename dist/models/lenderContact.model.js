 ...
 */
var LenderContactSchema = new _mongoose["default"].Schema({
  /**
   * created By
   * */
  createdBy: {
...
LenderContactSchema.plugin(_plugins.toJSON);
LenderContactSchema.plugin(_mongoosePaginateV["default"]);
LenderContactSchema.plugin(_plugins.softDelete, {
...
LenderContactSchema.statics.isEmailTaken = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, excludeLenderContactId) {
    var lenderContact;
...
var LenderContactModel = _mongoose["default"].models.LenderContact || _mongoose["default"].model('LenderContact', LenderContactSchema, 'LenderContact');
