...
LenderPlacementSchema.options.toJSON.transform = function (doc, {
  followOnDate,
  ...ret
}) {
  ...
  if (followOnDate) {
    ...
    if (followOnDateTimestamp < Date.now()) {
      ...
      ret = {
        ...ret,
        isEmailSent: enumModel.EnumOfEmailStatus.FOLLOW_UP,
...
const LenderPlacementModel = mongoose.models.LenderPlacement || mongoose.model('LenderPlacement', LenderPlacementSchema, 'LenderPlacement');
