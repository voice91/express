...
export async function ratesList(res, req, next) {
  try {
    ...
    const customSortOrderArray = [EnumOfRatesName.PRIME_RATE, EnumOfRatesName.SOFR, EnumOfRatesName.TREASURY_5_YEAR, EnumOfRatesName.TREASURY_7_YEAR, EnumOfRatesName.TREASURY_10_YEAR, EnumOfRatesName.SOFR_1_MONTH_AVG, EnumOfRatesName.SOFR_SWAP_2_YEAR, EnumOfRatesName.SOFR_SWAP_5_YEAR, EnumOfRatesName.SOFR_SWAP_7_YEAR, EnumOfRatesName.SOFR_SWAP_10_YEAR];
